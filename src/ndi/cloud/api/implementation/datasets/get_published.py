...
class GetPublished(Call):
    """
    Implementation class for getting published datasets from NDI Cloud.
    """

    def __init__(self, page=1, page_size=20):
        """
        Creates a new GetPublished API call object.
    ...
    def execute(self):
        """
        Performs the API call to get published datasets.
        """
        token = authenticate()
