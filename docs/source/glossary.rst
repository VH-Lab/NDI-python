...
.. glossary::
  ...
  NDI class
    A class derived from :class:`NDI_Object`, whose purpose is to act as a wrapper for one of the classes generated by `ndi_schema <>`_ and serve as simplified means of quickly converting between an :term:`NDI object` and and its :term:`flatbuffer` bytearrays.
