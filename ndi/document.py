...
class Document(NDI_Object):
    def __init__(self, document_extension: DocumentExtension = None, experiment_id: str = '', dependencies: List[Document] = [], version: int = 1, id_: str = None, document_type: str = '', base_id: str = ''):
        super().__init__(id_)
