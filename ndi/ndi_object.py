...
class NDI_Object(ABC):
    ...
    Child classes of :class:`NDI_Object` are wrappers for the classes generated by `ndi_schema<https://>`_ and serve as simplified interfaces for quickly converting between ndi objects and flatbuffer bytearrays.
    """
    @abstractmethod
