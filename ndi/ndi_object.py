...
class NDI_Object(ABC):
    ...
    """
    @abstractmethod
    def __init__(self, id_: T.NDI_id):
    ...
    @classmethod
    @abstractmethod
    def _reconstruct(cls, flatbuffer_object: T.Schema) -> T.NDI_object:
        """
    ...
    @classmethod
    def _reconstructList(cls, flatbuffer_object_parent: T.Schema) -> T.List[T.NDI_object]:
        """
